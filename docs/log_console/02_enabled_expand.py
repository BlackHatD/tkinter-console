...
if __name__ == '__main__':
    ...
    # create root object
    root = tk.Tk()
    root.title('02 Enabled Expand')

    # for using 'expand_btn''s arg settings
    root.minsize(width=640, height=0)
    ...
    ## customize expand button text
    #textvariable = tk.StringVar()
    #textvariable.set("( ﾟДﾟ)")
    #console_frame.expand_button.configure(textvariable=textvariable, width=10)
